...
import {
    ...
    QueryFunctionContext, UpdateManyResult, Identifier
} from 'react-admin';
...
export const dataProvider: DataProvider = {
    ...
    ): Promise<DeleteManyResult<RecordType>> => { // Возвращаемый результат с массивом идентификаторов удалённых записей
    ...
    ): Promise<GetManyReferenceResult<RecordType>> => { // Возвращаемый результат с массивом записей и общим количеством записей
    ...
    ): Promise<UpdateManyResult<RecordType>> => { // Возвращаемый результат с массивом идентификаторов обновлённых записей
