...
import UsersAdmin from "./resource/usersAdmin";
  ...
  return (
    <BrowserRouter>
      ...
      >
        <Resource
          name="usersAdmin"
          list={UsersAdmin(userPermissions).list}
          create={UsersAdmin(userPermissions).create}
          edit={UsersAdmin(userPermissions).edit}
        />
        <Resource
          name="users"
          list={UsersAdmin(userPermissions).list}
